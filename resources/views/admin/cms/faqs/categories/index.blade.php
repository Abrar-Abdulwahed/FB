...
@endsection
<a href={{ route('admin.faqs-categories.create') }} class="btn btn-info float-left my-2"> <i
            ...
            <tbody>
                @foreach ($categories as $index => $category)
                    <tr>
                        ...
                        <td>{{ $category->name }}</td>
                        <td>
                            <a href="{{ route('admin.faqs-categories.edit', $category->id) }}"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form
                                                action="{{ route('admin.faqs-categories.destroy', $category->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
