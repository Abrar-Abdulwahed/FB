    ...
    public function run(): void
    {
        ...
        if ($seeder == 0) {
            $settings = [
                ...
                'active_site' => 'active',
                'reason_locked' => '',
                'services.google_client_id' => '305295164959-957dbe2g9bm59oslqmjnjl96ek0sfiid.apps.googleusercontent.com',
                'services.google_client_secret' => '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',
                'services.google_client_redirect' => 'http://localhost:8000/auth/google/callback',
                'services.facebook_client_id' => '216796600748740',
                'services.facebook_client_secret' => '465dd3a53f01c039cf544bec281f8085',
                'services.facebook_client_redirect' => 'http://localhost:8000/auth/facebook/callback',
