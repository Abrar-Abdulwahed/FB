    ...
    public function store(SettingRequest $request)
    {
        ...
        try{
            ...
            $settings = [
                ...
                'google_enable'                     => $request->has('google_enable') ? "on":"off",
                'services.google.client_id'         => $request->has('google_enable') ? $request?->google_client_id: null,
                'services.google.client_secret'     => $request->has('google_enable') ? $request?->google_client_secret : null,
                'services.google.client_redirect'   => $request->has('google_enable') ?  $request?->google_client_redirect : null,
                'facebook_enable'                   => $request->has('facebook_enable') ? "on":"off",
                'services.facebook.client_id'       => $request->has('facebook_enable') ? $request?->facebook_client_id : null,
                'services.facebook.client_secret'   => $request->has('facebook_enable') ? $request?->facebook_client_secret : null,
                'services.facebook.client_redirect' => $request->has('facebook_enable') ? $request?->facebook_client_redirect : null,
